...
Model_3DS man,man2,tree,bird,rock,fence,fence2,luster;
float the_time=1;
...
void Key(bool* keys, float speed)
{
	...
	if (keys[VK_UP])
	{		MyCamera.MoveUpward(1 * speed*0.1);
	}
	if (keys[VK_DOWN])
	{
			MyCamera.MoveUpward(-1 * speed*0.1);
...
GLTexture head,hair,upper,shoes,eye,hand,buckle,lower,beard,accesories,tree_cane,tree_paper,bird_wave,rock_texture,fence_texture,fence2_texture,luster_texture;
...
//man.pos.x=MyCamera.Position.x;
	...
	SoundManager.CreateSound("stepsnow_1.wav", Sound);

	SoundManager1.Initialize(hWnd);
	SoundManager1.CreateSound("stepsnow_2.wav", Sound1);
    ...
    // Enable depth testing and normalize normals
...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawingzxc
{
	...
	if(	MyCamera.Position.x>=550&&MyCamera.Position.x<=570&&MyCamera.Position.z <535)
...
//الجانب الاول
  //الجدار
  glPushMatrix();
  glTranslated(500,980,4000);
  ar.multi_wall_1(50, the_floor);
  glPopMatrix();
  //العضاضة الاولى
  glPushMatrix();
  glTranslated(1150,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الاول
  glPushMatrix();
  glTranslated(1160,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  glTranslated(1230,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثاني
  glPushMatrix();
  glTranslated(1240,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //العضاضة الثالثة
  glPushMatrix();
  glTranslated(1320,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثالث
  glPushMatrix();
  glTranslated(1330,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(1140,1050,4000);
    ar.angel_roof(Point (0, 0, -19), Point(210, 0, -19), Point(210, 12, -19), Point(0, 12, -19), Point(0, 0, 1), Point(210, 0, 1), Point(210, 12, 1), Point(0, 12, 1),the_floor);
  glPopMatrix();
  ...
  //الجدار
  glPushMatrix();
  glTranslated(1337,980,4000);
  ar.multi_wall_1(50, the_floor);
  glPopMatrix();
  //العضاضة الاولى
  glPushMatrix();
  glTranslated(1987,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الاول
  glPushMatrix();
  glTranslated(1997,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  glTranslated(2067,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثاني
  glPushMatrix();
  glTranslated(2077,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //العضاضة الثالثة
  glPushMatrix();
  glTranslated(2157,980,4000);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثالث
  glPushMatrix();
  glTranslated(2167,1030,3990);
  ar.newpyramid(Point (0, 0, 0), Point(-20, 20, -10), Point(-20, 20, 10), Point(20, 20, -10), Point(20, 20, 10), Point(-20, 20, -10),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(1977,1050,4000);
    ar.angel_roof(Point (0, 0, -19), Point(210, 0, -19), Point(210, 12, -19), Point(0, 12, -19), Point(0, 0, 1), Point(210, 0, 1), Point(210, 12, 1), Point(0, 12, 1),the_floor);
  glPopMatrix();
  ...
  //الجدار
  glPushMatrix();
  glTranslated(2174,980,4000);
  ar.multi_wall_1(48, the_floor);
  glPopMatrix();
...
//الجانب الثالث
  ...
  //الهرم الاول
  glPushMatrix();
  glTranslated(2800,1025,1180);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  ...
  //الهرم الثالث
  glPushMatrix();
  glTranslated(2800,1025,1330);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(2800,1045,1170);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 12, -19), Point(0, 12, -19), Point(0, 0, 190), Point(15, 0, 190), Point(15, 12, 190), Point(0, 12, 190),the_floor);
  glPopMatrix();
...
//الجانب الرابع
  ...
  //العضاضة الاولى
  glPushMatrix();
  glTranslated(500,980,1180);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الاول
  glPushMatrix();
  glTranslated(500,1025,1180);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  glTranslated(500,980,1260);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثاني
  glPushMatrix();
  glTranslated(500,1025,1250);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثالثة
  glPushMatrix();
  glTranslated(500,980,1340);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثالث
  glPushMatrix();
  glTranslated(500,1025,1330);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(500,1045,1170);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 12, -19), Point(0, 12, -19), Point(0, 0, 190), Point(15, 0, 190), Point(15, 12, 190), Point(0, 12, 190),the_floor);
  glPopMatrix();
  ...
  //الجدار
  glPushMatrix();
  glTranslated(500,980,1335);
  ar.multi_wall_2(50, the_floor);
  glPopMatrix();
  //العضاضة الاولى
  glPushMatrix();
  glTranslated(500,980,2005);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الاول
  glPushMatrix();
  glTranslated(500,1025,2005);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  glTranslated(500,980,2085);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثاني
  glPushMatrix();
  glTranslated(500,1025,2075);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثالثة
  glPushMatrix();
  glTranslated(500,980,2165);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثالث
  glPushMatrix();
  glTranslated(500,1025,2155);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(500,1045,1995);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 12, -19), Point(0, 12, -19), Point(0, 0, 190), Point(15, 0, 190), Point(15, 12, 190), Point(0, 12, 190),the_floor);
  glPopMatrix();
...
//الجدار
  glPushMatrix();
  glTranslated(500,980,2160);
  ar.multi_wall_2(50, the_floor);
  glPopMatrix();
  //العضاضة الاولى
  glPushMatrix();
  glTranslated(500,980,2830);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الاول
  glPushMatrix();
  glTranslated(500,1025,2830);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثانية
  glPushMatrix();
  glTranslated(500,980,2910);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثاني
  glPushMatrix();
  glTranslated(500,1025,2900);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //العضاضة الثالثة
  glPushMatrix();
  glTranslated(500,980,2990);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 60, -19), Point(0, 60, -19), Point(0, 0, 1), Point(15, 0, 1), Point(15, 60, 1), Point(0, 60, 1),the_floor);
  glPopMatrix();
  //الهرم الثالث
  glPushMatrix();
  glTranslated(500,1025,2980);
  ar.newpyramid(Point (0, 0, 0), Point(-10, 20, 20), Point(10, 20, 20), Point(10, 20, -20), Point(-10, 20, -20), Point(-10, 20, 20),the_floor);
  glPopMatrix();
  //السقفف
  glPushMatrix();
  glTranslated(500,1045,2820);
    ar.angel_roof(Point (0, 0, -19), Point(15, 0, -19), Point(15, 12, -19), Point(0, 12, -19), Point(0, 0, 190), Point(15, 0, 190), Point(15, 12, 190), Point(0, 12, 190),the_floor);
  glPopMatrix();
  //الجدار
  glPushMatrix();
  glTranslated(500,980,2985);
  ar.multi_wall_2(80, the_floor);
  glPopMatrix();
